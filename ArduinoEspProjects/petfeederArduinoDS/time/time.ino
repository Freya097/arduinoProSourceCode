...
Servo servo_mot; //Download here: https://electronoobs.com/eng_arduino_ds3231.php  
#define OLED_RESET 7
Adafruit_SSD1306 display(OLED_RESET); //Download here: https://electronoobs.com/eng_arduino_ds3231.php  
// Init the DS3231 using the hardware interface
//http://electronoobs.com/eng_arduino_tut163_code1.php
