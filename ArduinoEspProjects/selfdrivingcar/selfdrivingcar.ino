...
#define TRIGGER_PIN  4  // Arduino pin to trigger pin on the ultrasonic sensor.
#define ECHO_PIN     5  // Arduino pin to echo pin on the ultrasonic sensor.
...
void setup()
{
  ...
  servo_motor.attach(3);   // Attachs the servo on pin 9 to servo object.
...
{  
  ...
  if (distance <= 50)   //If distance of obstacle less than 30 cm from robot 
  {
